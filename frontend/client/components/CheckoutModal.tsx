 ...
 * Handles email collection and initiates Cashfree SDK payment flow.
 */
const CheckoutModal: React.FC<CheckoutModalProps> = ({ isOpen, onClose, tool }) => {
  ...
  const handleCheckout = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Trigger Cashfree Checkout UI
      ...
      await cashfree.checkout({
        ...
        returnUrl: `http://localhost:3000/activate/{order_id}` // Handled by Cashfree
      });
          ...
          >
            ...
            <div className="p-10 md:p-12">
              ...
              <div className="flex items-center gap-6 mb-10 pb-10 border-b border-white/5">
                ...
                <div>
                  <h3 className="text-2xl font-black font-montserrat text-white mb-2">{tool.title}</h3>
                  <div className="flex items-center gap-3">
                    <span className="text-3xl font-black text-cyan-400">₹{tool.discount_price || tool.price}</span>
                    <span className="text-xs font-black uppercase tracking-widest text-white/20 line-through">₹{tool.price}</span>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleCheckout} className="space-y-8">
                <div className="space-y-4">
                  <label className="text-[10px] font-black uppercase tracking-[0.2em] text-cyan-500/80 flex items-center gap-2">
                    <Mail className="w-3 h-3" /> Delivery Destination
                  </label>
                  ...
                  <p className="text-[10px] text-white/30 font-medium">Your premium access link will be bound to this email address.</p>
                </div>
                  ...
                  <div className="relative flex items-center justify-center gap-3">
                    {loading ? (
                      ...
                      <>
                        ...
                        <span className="text-lg tracking-tight uppercase">SECURE CHECKOUT</span>
              ...
              <div className="mt-12 pt-8 border-t border-white/5 flex items-center justify-between opacity-40">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-white">Bank Grade SSL</span>
                </div>
                <div className="flex items-center gap-2">

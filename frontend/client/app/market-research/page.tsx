  ...
  return (
    <div className="min-h-screen pt-24 px-8 md:px-24">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-inter font-bold mb-4">Market Research Intelligence</h1>
        ...
        {analyzing && (
          <div className="h-64 flex flex-col items-center justify-center bg-white/5 border border-white/10 rounded-2xl">
            ...
            <h3 className="font-inter font-bold text-xl animate-pulse text-white">Aggregating Market Data...</h3>
        ...
        {results && (
          <div className="bg-white/5 border border-cyan-500/30 p-8 rounded-2xl animate-in fade-in zoom-in duration-500">
            <h2 className="text-2xl font-inter font-bold text-cyan-400 mb-6">Research Complete: Viability High</h2>

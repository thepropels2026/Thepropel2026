                        ...
                        {tool.discount_price !== undefined && tool.discount_price !== null ? (
                          <>
                            ...
                            {tool.price > tool.discount_price && (
                              <div className="flex flex-col">
                                <span className="text-[9px] text-red-600 font-black uppercase tracking-widest mb-0.5">Retail Price</span>
                                <span className="text-xl text-red-600 font-black line-through decoration-red-600 decoration-[3px]">₹{tool.price}</span>
                              </div>
                            )}
                          </>
                        ) : (
